...
int main()
{
    ...
    //                 nbAEF++;
    //                 liste_aef = (t_AEF **)realloc(liste_aef, nbAEF * sizeof(t_AEF));
    //                 liste_aef[nbAEF] = (t_AEF *)transformerAutomateComplet(liste_aef[choix2]);
    //                 afficherAEF(liste_aef[nbAEF]);
    //                 system("pause");
    //             }
    //         }
    ...
    //                 nbAEF++;
    //                 liste_aef = (t_AEF **)realloc(liste_aef, nbAEF * sizeof(t_AEF));
    //                 liste_aef[nbAEF] = (t_AEF *)transformerAutomateDeterministe(liste_aef[choix2]);
    //                 afficherAEF(liste_aef[nbAEF]);
    //                 system("pause");
    //             }
    //         }
    ...
    t_AEF *aef_emonder = complementaireAEF(*aef);

    afficherAEF(aef_emonder);
